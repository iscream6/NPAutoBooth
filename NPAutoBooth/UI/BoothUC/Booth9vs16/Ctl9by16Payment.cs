...
namespace NPAutoBooth.UI.BoothUC
{
    ...
    public partial class Ctl9by16Payment : PaymentUC
    {
        ...
        public override void SetPageChangeButtonVisible(bool visibled)
        {
            btn_TXT_BACK.Visible = visibled;
            btn_TXT_HOME.Visible = visibled;
        }
