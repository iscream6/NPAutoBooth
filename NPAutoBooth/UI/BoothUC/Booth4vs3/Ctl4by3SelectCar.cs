...
namespace NPAutoBooth.UI.BoothUC
{
    ...
    public partial class Ctl4by3SelectCar : SelectCarUC
    {
        ...
        public override void SetCarInfo(ENUM_CarIndex carIndex, SelectCarInfo carInfo)
        {
            switch (carIndex)
            {
                ...
                case ENUM_CarIndex.Three:
                    ...
                    break;
                case ENUM_CarIndex.Four:
                    btn_FourCarimage.Image = carInfo.carImage;
                    lbl_FourCarnumber.Text = carInfo.carNumber;
                    break;
            }
        }
        ...
        public override void SetCarInfoEnable(ENUM_CarIndex carIndex, bool enabled)
        {
            switch (carIndex)
            {
                ...
                case ENUM_CarIndex.Three:
                    ...
                    break;
                case ENUM_CarIndex.Four:
                    btn_FourCarimage.Enabled = enabled;
                    break;
            }
        }
        ...
        public override void SetCarInfoColor(ENUM_CarIndex carIndex, Color color)
        {
            switch (carIndex)
            {
                ...
                case ENUM_CarIndex.Three:
                    ...
                    break;
                case ENUM_CarIndex.Four:
                    lbl_FourCarnumber.ForeColor = color;
                    break;
            }
        }
                ...
                if(c != null)
                {
                    switch (c.Name)
                    {
                        ...
                        case "lbl_ThreeCarnumber":
                            ...
                            Car_Selected(3);
                            break;
                        case "btn_FourCarimage":
                        case "lbl_FourCarnumber":
                            //4번 차량 선택
                            SelectedCarNumber = lbl_FourCarnumber.Text;
                            Car_Selected(4);
                            break;
                    }
                }
