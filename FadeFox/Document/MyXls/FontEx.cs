...
namespace FadeFox.Document.MyXls
{
    ...
    /// </summary>
	public class FontEx : ICloneable
	{
        /*
            ----------------------------------------------------------------------------
        ...
        */
        ...
        internal FontEx(XlsDocument doc)
        {
        ...
        internal FontEx(XlsDocument doc, XF xf) : this(doc)
		{
            _target = xf;
        }

        internal FontEx(XlsDocument doc, Bytes bytes) : this(doc)
        {
            ReadBytes(bytes);
        }
		...
		public bool Equals(FontEx that)
		{
		...
		public object Clone()
		{
            FontEx clone = new FontEx(_doc, _target);
