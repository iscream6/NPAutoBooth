...
using System.IO;
using System.Text;
using FadeFox.Document.MyOle2;
using FadeFox.Document.MyOle2.Metadata;
...
namespace FadeFox.Document.MyXls
{
    ...
    public class XlsDocument
    {
        ...
        internal XlsDocument(string fileName, Workbook.BytesReadCallback workbookBytesReadCallback)
        {
            ...
            _workbook = new Workbook(this, _ole2Doc.Streams[_ole2Doc.Streams.GetIndex(FadeFox.Document.MyOle2.Directory.Biff8Workbook)].Bytes, workbookBytesReadCallback);
        }
        ...
        public XlsDocument(System.IO.Stream stream)
        {
            ...
            //TODO: SummaryInformationSection and DocumentSummaryInformationSections should be read by MyOle2
            _workbook = new Workbook(this, _ole2Doc.Streams[_ole2Doc.Streams.GetIndex(FadeFox.Document.MyOle2.Directory.Biff8Workbook)].Bytes, null);
        }
        ...
        /// <summary>
        /// Gets this FadeFox.Document.MyXls XlsDocument's OLE2 Document.
        /// </summary>
        public MyOle2.Ole2Document OLEDoc { get { return _ole2Doc; } }

        /// <summary>
        /// Gets this FadeFox.Document.MyXls XlsDocument's Workbook.
        /// </summary>
		...
		/// <summary>
		/// Save this XlsDocument to the given path.  The FileName property will be used for the FileName.
		/// </summary>
		/// <param name="path">The Path to which to save this XlsDocument.</param>
		/// <param name="overwrite">Whether to overwrite if the specified file already exists.</param>
		/// <param name="execute">저장후 파일 실행 여부</param>
		public void Save(string path, bool overwrite, bool execute)
		{
