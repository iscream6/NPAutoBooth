...
//        private const ushort DEFAULT_LINE_COLOUR_INDEX = 8;
        ...
        internal XF(XlsDocument doc, Bytes bytes, FontEx font, string format) : this(doc)
        {
        ...
        internal void OnFontChange(FontEx newFont)
        {
            _font = (FontEx) newFont.Clone();
            //_font.ID = newFont.ID;
            OnChange();
        }
		...
		public FontEx Font
		{
			...
			set
			{
				...
				_font = (value == null ? null : (FontEx) value.Clone());
				OnChange(); 
			}
		}
		...
		private ColorEx _leftLineColor;
		private ColorEx _rightLineColor;
...
//                    _bottomLineColorIndex = DEFAULT_LINE_COLOUR_INDEX;
		...
		public ColorEx LeftLineColor
		{
			...
			set
			{
                ...
                _leftLineColor = (ColorEx)value.Clone();
				OnChange();
			}
		}
		...
		public ColorEx RightLineColor
		{
			...
			set
			{
                ...
                _rightLineColor = (ColorEx)value.Clone();
				OnChange();
			}
		}
		...
		private ColorEx _topLineColor;
		private ColorEx _bottomLineColor;
		private ColorEx _diagonalLineColor;
		...
		public ColorEx TopLineColor
		{
			...
			set
			{
                ...
                _topLineColor = (ColorEx)value.Clone();
				OnChange();
			}
		}
		...
		/// </summary>
		public ColorEx BottomLineColor
		{
			...
			set
			{
                ...
                _bottomLineColor = (ColorEx)value.Clone();
				OnChange();
			}
		}
		...
		/// </summary>
		public ColorEx DiagonalLineColor
		{
			...
			set
			{
				...
				_diagonalLineColor = (ColorEx)value.Clone();
				OnChange();
			}
		}
...
//                    _diagonalLineColorIndex = DEFAULT_LINE_COLOUR_INDEX;
		...
		private ColorEx _patternColor;
		private ColorEx _patternBackgroundColor;

        /// <summary>
		/// Gets or sets Colour for pattern colour.
		/// </summary>
		public ColorEx PatternColor
		{
			...
			set
			{
			    ...
			    _patternColor = (ColorEx) value.Clone();
				OnChange();
			}
		}
		...
		/// </summary>
		public ColorEx PatternBackgroundColor
		{
			...
			set
			{
				...
				_patternBackgroundColor = (ColorEx)value.Clone();
				OnChange();
			}
		}
        ...
        private void ReadBytes(Bytes bytes, FontEx font, string format)
        {
            _font = font;
            _format = format;
