...
namespace FadeFox.Document.ExcelLite.CompoundDocumentFormat
{
    public class DirectoryTree
    {
        ...
        private static byte GetNodeColor(FadeFox.Document.ExcelLite.Library.NodeColor nodeColor)
        {
            switch (nodeColor)
            {
				case FadeFox.Document.ExcelLite.Library.NodeColor.Black:
                    return NodeColor.Black;
				case FadeFox.Document.ExcelLite.Library.NodeColor.Red:
